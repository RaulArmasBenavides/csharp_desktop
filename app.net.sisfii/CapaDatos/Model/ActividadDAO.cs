...
namespace CapaDatos.Model
{
    ...
    {   // entidades  usando ENTITY FRAMEWORK
        ...
        public void create(usp_actividades_listar_all_Result t)
        {
           // objeto de tipo objectparameter para guardar el idproduto que devuelve el store
            ...
            e.usp_registrar_actividad(t.descripcion,t.rol_creacion,t.idasistencias,t.idlistaeq,t.idsala);
            
           // t.idactividad = Convert.ToInt32(cod.Value.ToString()); // opcional
            //dc.SaveChanges();
        }

        public void delete(usp_actividades_listar_all_Result t)
        {
        ...
        public usp_actividades_listar_all_Result find(usp_actividades_listar_all_Result t)
        {

               /* usp_actividades_listar_all_Result dato = null;
               var pro = dc.usp_Productos_Datos(t.idactividad);
               var aux = e - usp_actividades_listar_all_Result(t.idactividad);
               foreach (var item in pro)
               {
                   dato = new usp_actividades_listar_all_Result()
                   {
        ...
        public usp_actividades_listar_all_Result BuscarporDescripcion(usp_actividades_listar_all_Result t)
        {
        ...
        public usp_actividades_listar_all_Result BuscarporFecha(usp_actividades_listar_all_Result t)
        {
...
public List<usp_actividades_listar_all_Result> readAll()
{
return e.usp_actividades_listar_all().ToList();
}

public void update(usp_actividades_listar_all_Result t)
{
